...
class IDsOptions(tk.Toplevel):
    def __init__(self, tab):
        ...
        self.image_size_entry.grid(row=3, column=1, sticky='w', columnspan=2)

        self.font_size_label = tk.Label(self.output_options_frame, text='Font Size: ')
        self.font_size_label.grid(row=4, column=0, sticky='w')
        ...
        self.font_size_entry.grid(row=4, column=1, sticky='w', columnspan=2)
        ...
        self.limit_requests_label.grid(row=0, column=0, sticky='w')
        ...
        self.limit_requests_combobox.grid(row=0, column=1, sticky='ew')
    
        self.request_period_label = tk.Label(self.technical_options_frame, text='Request Period: ')
        self.request_period_label.grid(row=1, column=0, sticky='w')
        ...
        self.request_period_entry.grid(row=1, column=1, sticky='w')
    
        self.requests_per_period_label = tk.Label(self.technical_options_frame, text='Requests Per Period: ')
        self.requests_per_period_label.grid(row=2, column=0, sticky='w')
        ...
        self.requests_per_period_entry.grid(row=2, column=1, sticky='w')
    
        self.simultaneous_scans_label = tk.Label(self.technical_options_frame, text='Simultaneous Scans: ')
        self.simultaneous_scans_label.grid(row=3, column=0, sticky='w')
        ...
        self.simultaneous_scans_entry.grid(row=3, column=1, sticky='w')
    ...
    def apply(self):
        ...
        if self.max_hours_entry.get():
            self.check_entry_integer(self.max_hours_entry, self.tab.process_manager.config['ids']['max_hours'])
        ...
        if self.displayed_items_entry.get() != self.tab.process_manager.config['output']['displayed_items']:
        ...
        self.tab.process_manager.config[
            'technical']['limit_requests'] = str(self.limit_requests_combobox.get() == 'True')
    ...
    def set_as_default(self):
        ...
        self.tab.process_manager.config['ids']['display_players'] = self.tab.display_players
        self.tab.process_manager.config['ids']['collect_hours'] = self.tab.collect_hours
        self.tab.process_manager.config['ids']['f2p'] = self.tab.f2p
        self.tab.process_manager.config['ids']['status'] = self.tab.status
        self.tab.process_manager.config['ids']['max_hours'] = self.tab.max_hours
        self.tab.process_manager.config['ids']['currency'] = self.tab.currency
        self.tab.process_manager.config['ids']['minimum_item_value'] = self.tab.minimum_item_value
        self.tab.process_manager.config['ids']['minimum_item_value_currency'] = self.tab.minimum_item_value_currency
        self.tab.process_manager.config['ids']['raw_minimum_item_value'] = self.tab.raw_minimum_item_value
        self.tab.process_manager.config['ids']['minimum_player_value'] = self.tab.minimum_player_value
        self.tab.process_manager.config['ids']['minimum_player_value_currency'] = self.tab.minimum_player_value_currency
        self.tab.process_manager.config['ids']['raw_minimum_player_value'] = self.tab.raw_minimum_player_value
        self.tab.process_manager.config['ids']['last_online'] = self.tab.last_online
        self.tab.process_manager.config['ids']['raw_last_online'] = self.tab.raw_last_online
